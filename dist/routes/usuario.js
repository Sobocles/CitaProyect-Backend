...
router.post('/', [
    ...
    (0, express_validator_1.check)('password', 'La contraseña es obligatoria y debe tener al menos 6 caracteres').isLength({ min: 6 }),
    (0, express_validator_1.check)('fecha_nacimiento', 'Fecha de nacimiento inválida').isISO8601(),
